...
fun PrayerResetScreen(
    ...
    Column(
        ...
        Spacer(Modifier.Companion.height(Dimensions.dialogPadding))
        Text(
            text = stringResource(R.string.restart_prayer_message),
            style = MaterialTheme.typography.bodyMedium
        )
        Spacer(Modifier.Companion.height(Dimensions.spacerHeight))
        Row(
            ...
            Spacer(Modifier.Companion.width(Dimensions.height))
